...
import com.example.bazar.util.Constants.NO_PAYMENT
import com.google.gson.JsonObject
import androidx.core.content.edit

class CartRepositoryImpl(private val apiService: ApiService, private val sharedPref: SharedPreferences) : CartRepository {
    ...
    override fun setPurchaseStatus(status: Int) {
        sharedPref.edit { putInt("purchase_status", status) }
    }
